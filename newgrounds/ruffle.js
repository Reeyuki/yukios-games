function swfUrlToLocalPath(url) {
  const u = new URL(url);
  const filename = u.pathname.split("/").pop();
  console.log(url, filename);
  return "static/games/swfGames/" + filename;
}
...
(() => {
  ...
  var e,
    ...
    a = {
      ...
      65(e, n) {
        (Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.classnames = function (e) {
            const n = o(e).filter(t);
            return n.length > 0 ? n.join(" ") : void 0;
          }));
        const a = (e) => !!e,
          t = (e, n, a) => a.indexOf(e) === n,
          r = [];
        function o(e) {
          return e
            ? "string" == typeof e
              ? [e]
              : Array.isArray(e)
                ? e.flatMap(o).filter(a)
                : ((n = e), Object.entries(n).map(([e, n]) => n && e)).filter(a)
            : r;
          var n;
        }
      },
      124(e, n, a) {
        e.exports = a.p + "8e3d5ae171d05b6cb461.wasm";
      },
      125(e, n) {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
      136(e, n, a) {
          ...
          (n.setAttributes = function (e, n) {
            for (const a of Object.keys(n)) {
              ...
              if ("class" === a) {
                ...
                n && e.setAttribute(a, n);
              } else if ("ref" === a) i.current = e;
              else if (o.test(a)) {
                const n = a.replace(/Capture$/, ""),
                  t = a !== n,
                  r = n.toLowerCase().substring(2);
                e.addEventListener(r, i, t);
              } else
                "style" === a && "string" != typeof i
                  ? r(i, e.style)
        ...
        const t = a(665);
        function r(e, n) {
          for (const a of Object.keys(e)) a in n && (n[a] = e[a]);
        }
        const o = /^on\p{Lu}/u;
      },
      269(e, n) {
      ...
      325(e, n, a) {
        (Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.defineCustomElement = function (e, n, a) {
            return (customElements.define(e, n, a), (n) => (0, t.jsx)(e, n));
          }));
        const t = a(553);
      },
      460(e, n) {
      ...
      553(e, n, a) {
        ...
        function o(e, n) {
          ...
          return ((0, t.setAttributes)(l, s), (0, r.applyChildren)(l, [a]), l);
        }
      },
      665(e, n, a) {
        var t =
      ...
      797(e, n, a) {
        e.exports = a.p + "a13f44d99cb7b0d74d28.wasm";
      },
      836(e, n) {
        Object.defineProperty(n, "__esModule", { value: !0 });
      },
      ...
      r.f.j = (n, a) => {
        ...
        if (0 !== t)
          if (t) a.push(t[2]);
            ...
            var o = new Promise((a, r) => (t = e[n] = [a, r]));
            a.push((t[2] = o));
            var i = r.p + r.u(n),
              s = new Error();
            r.l(
  ...
  class o {
    ...
    static fromSemver(e) {
      ...
      let i = 0,
        ...
        u = null;
      return (
        void 0 !== t[1] && (i = parseInt(t[1], 10)),
        void 0 !== t[2] && (s = parseInt(t[2], 10)),
        void 0 !== a[1] && (l = a[1].split(".")),
    ...
    hasPrecedenceOver(e) {
      ...
      if (null !== this.prIdent && null !== e.prIdent) {
        ...
        for (
          ...
          if (!r && t) return !0;
          if (r && t) {
            const n = parseInt(this.prIdent[a], 10),
              t = parseInt(e.prIdent[a], 10);
            if (n > t) return !0;
            if (n < t) return !1;
          } else {
            if (r && !t) return !1;
            if (!r && !t) {
              if (this.prIdent[a] > e.prIdent[a]) return !0;
              if (this.prIdent[a] < e.prIdent[a]) return !1;
            }
          }
        }
      ...
      if (null !== this.buildIdent && null !== e.buildIdent) {
        ...
        for (
          ...
          if (!t && r) return !0;
          if (t && r) {
            const n = parseInt(this.buildIdent[a], 10),
              t = parseInt(e.buildIdent[a], 10);
            if (n > t) return !0;
            if (n < t) return !1;
          } else {
            if (t && !r) return !1;
            if (!t && !r) {
              if (this.buildIdent[a] > e.buildIdent[a]) return !0;
              if (this.buildIdent[a] < e.buildIdent[a]) return !1;
            }
          }
        }
  ...
  class i {
    ...
    satisfiedBy(e) {
      for (const n of this.requirements) {
        let a = !0;
        for (const { comparator: t, version: r } of n)
          ((a = a && r.isStableOrCompatiblePrerelease(e)),
            "" === t || "=" === t
              ? (a = a && r.isEqual(e))
              : ">" === t
                ? (a = a && e.hasPrecedenceOver(r))
                : ">=" === t
                  ? (a = a && (e.hasPrecedenceOver(r) || r.isEqual(e)))
                  : "<" === t
                    ? (a = a && r.hasPrecedenceOver(e))
                    : "<=" === t
                      ? (a = a && (r.hasPrecedenceOver(e) || r.isEqual(e)))
                      : "^" === t && (a = a && r.isCompatibleWith(e)));
        if (a) return !0;
      }
      return !1;
    }
    static fromRequirementString(e) {
      ...
      const t = [];
      for (const e of n)
        if ("||" === e) a.length > 0 && (t.push(a), (a = []));
        else if (e.length > 0) {
          const n = /[0-9]/.exec(e);
          if (n) {
            const t = e.slice(0, n.index).trim(),
              r = o.fromSemver(e.slice(n.index).trim());
            a.push({ comparator: t, version: r });
          }
        }
      return (a.length > 0 && t.push(a), new i(t));
    }
  }
  class s {
    constructor(e) {
    ...
    newestSourceName() {
      ...
      for (const a in this.sources)
        if (Object.prototype.hasOwnProperty.call(this.sources, a)) {
          const t = o.fromSemver(this.sources[a].version);
          t.hasPrecedenceOver(n) && ((e = a), (n = t));
        }
      return e;
    }
    init() {
    ...
    satisfying(e) {
      ...
      for (const e in this.sources)
        if (Object.prototype.hasOwnProperty.call(this.sources, e)) {
          const t = o.fromSemver(this.sources[e].version);
          n.satisfiedBy(t) && (a = this.sources[e]);
        }
      return a;
    }
    localCompatible() {
  ...
  const l = {
    versionNumber: "0.2.0-nightly.2026.1.8",
  ...
  class A extends z {
    static supportsValue(e) {
      ...
      if (e instanceof z) return A.supportsValue(e.valueOf());
      ...
      case "func":
        return (function (e, { name: n, args: a }) {
          ...
          try {
            ...
            return (e.reportError(a), new S(`${n}()`));
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: a, star: t }) {
          let r = P(e, n);
          if (r instanceof S) return F(e, a, t);
          for (const n of a) {
            if (E(e, r, P(e, n.key))) return $(e, n.value);
          }
          return F(e, a, t);
        })(e, n);
      default:
  ...
  class O {
    ...
    memoizeIntlObject(e, n) {
      let a = this.bundle._intls.get(e);
      a || ((a = {}), this.bundle._intls.set(e, a));
      let t = JSON.stringify(n);
      return (a[t] || (a[t] = new e(this.bundle.locales, n)), a[t]);
    }
  }
  function M(e, n) {
  ...
  function T(e, n) {
    let a = e[0];
    if (a instanceof S) return new S(`NUMBER(${a.valueOf()})`);
    if (a instanceof C) return new C(a.valueOf(), { ...a.opts, ...M(n, I) });
    if (a instanceof A) return new C(a.toNumber(), { ...M(n, I) });
  ...
  function L(e, n) {
    let a = e[0];
    if (a instanceof S) return new S(`DATETIME(${a.valueOf()})`);
    if (a instanceof A || a instanceof C) return new A(a, M(n, W));
  ...
  class _ {
    constructor(
      ...
      ((this._terms = new Map()),
        ...
        (this._useIsolating = a),
        (this._transform = t),
        (this._intls = (function (e) {
          const n = Array.isArray(e) ? e.join(" ") : e;
          let a = N.get(n);
          return (void 0 === a && ((a = new Map()), N.set(n, a)), a);
        })(e)));
    }
    hasMessage(e) {
    ...
    formatPattern(e, n = null, a = null) {
      if ("string" == typeof e) return this._transform(e);
      let t = new O(this, a, n);
      try {
  ...
  class me {
    constructor(e) {
      ...
      function a(a) {
        return ((a.lastIndex = n), a.test(e));
      }
      function t(a, t) {
        if (e[n] === a) return (n++, !0);
        if (t) throw new t(`Expected ${a}`);
        return !1;
      }
      function r(e, t) {
        if (a(e)) return ((n = e.lastIndex), !0);
      ...
      function o(a) {
        a.lastIndex = n;
        let t = a.exec(e);
        if (null === t) throw new SyntaxError(`Expected ${a.toString()}`);
        return ((n = a.lastIndex), t);
      }
      function i(e) {
        return o(e)[1];
      }
        ...
        let n = l(),
          t = (function () {
            ...
            for (; a(B); ) {
              let n = i(B),
                a = l();
              if (null === a) throw new SyntaxError("Expected attribute value");
              e[n] = a;
            }
            return e;
          })();
      ...
      function u(t = [], r) {
        for (;;) {
          ...
          let o = g();
          if (!o) break;
          (t.push(o), (r = Math.min(r, o.length)));
        }
        let o = t.length - 1,
          s = t[o];
      ...
      function d() {
        ...
        if (a(K)) {
          ...
          if (r(le)) {
            ...
            if ("-" === a) return { type: "term", name: t, attr: i, args: o };
      ...
      function h() {
        let [, e, n = ""] = o(J),
          a = n.length;
        return { type: "num", value: parseFloat(e), precision: a };
      }
      function v() {
        if (a(G)) return i(G);
        if (a(X)) {
          let [, e, n] = o(X),
            a = parseInt(e || n, 16);
          return a <= 55295 || 57344 <= a ? String.fromCodePoint(a) : "\ufffd";
        }
      ...
      function g() {
        ...
        switch ((r(fe), e[n])) {
          ...
          case void 0:
            return !1;
          case "{":
            return w(e.slice(a, n));
        }
        return " " === e[n - 1] && w(e.slice(a, n));
      }
      function b(e, n) {
        return e.replace(n, "");
      }
  ...
  class ve {
    constructor(e) {
      ...
      let [, a, t, r, o] = n;
      (a && (this.language = a.toLowerCase()),
        t && (this.script = t[0].toUpperCase() + t.slice(1)),
      ...
      e: for (const n of e) {
        ...
        if (void 0 !== o.language) {
          for (const n of r.keys())
            if (e === n.toLowerCase()) {
              if ((t.add(n), r.delete(n), "lookup" === a)) return Array.from(t);
  ...
  function Se(e, n, a) {
    const t = ze[e];
    if (void 0 !== t) {
      const e = t.getMessage(n);
      if (void 0 !== e && e.value) return t.formatPattern(e.value, a);
    }
    return null;
  }
  function Ce(e, n) {
    const a = ke(),
      t = we(navigator.languages, Object.keys(ze), { defaultLocale: "en-US" });
    for (const a in t) {
      const r = Se(t[a], e, n);
      if (r) return r;
    }
    return (console.error(`Unknown text key '${e}'`), ye(a), e);
  }
  function Ae(e, n) {
      ...
      (0, j.jsx)(function () {
        return (0, j.jsx)("div", {
          ...
          children: (0, j.jsxs)("div", {
            ...
            children: [
              (0, j.jsx)("span", { class: "close-modal" }),
              (0, j.jsx)("h2", { children: Ce("clipboard-message-title") }),
              (0, j.jsx)("p", { id: "clipboard-modal-description" }),
              (0, j.jsxs)("p", {
                children: [
  ...
  const qe = "application/x-shockwave-flash",
    ...
    $e = "application/vnd.adobe.flash.movie";
  function Oe(e, n) {
    const a = (function (e) {
      let n = "";
      try {
  ...
  try {
    if (
      ...
      (e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (Me = new URL(".", e)),
        (Ie = Me.protocol.includes("extension")));
    }
  } catch (e) {
                      ...
                      });
                    {
                      ...
                      return (
                        a.stackIndex > -1 &&
                          ...
                          ((a[a.stackIndex] = null),
                          a.avmStackIndex > -1 && (a[a.avmStackIndex] = null),
  ...
  function nn(e, n) {
    const a = en[e];
    if (void 0 !== a) {
      if (a.class !== n) throw new Error("Internal naming conflict on " + e);
      return a.name;
    }
    let t = 0;
  ...
  function tn(e, n) {
    if (
      (an(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      an(n.backgroundColor) &&
      ...
      an(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      an(n.base) && e.setBaseUrl(n.base),
      an(n.menu) && e.setShowMenu(n.menu),
      an(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      an(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      an(n.forceAlign) && e.setForceAlign(n.forceAlign),
      an(n.quality)
      ...
      an(n.wmode) && e.setWmode(n.wmode),
      an(n.logLevel) && e.setLogLevel(n.logLevel),
      an(n.maxExecutionDuration) &&
  ...
  function sn(e) {
    ...
    const n = {};
    for (const [a, t] of e) n[a] = t.toString();
    return n;
  }
  class ln {
    constructor(e, n) {
  ...
  class un {
    constructor(e, n, a) {
      ((this.contextMenuForceDisabled = !1),
        ...
        (this.onFSCommand = []),
        (this.config = {}),
        (this.SaveRow = ({ rowKey: e, solName: n, solData: a }) =>
          (0, j.jsxs)("tr", {
            children: [
              (0, j.jsx)("td", { title: e, children: n }),
              (0, j.jsx)("td", {
    ...
    callFSCommand(e, n) {
      ...
      for (const a of this.onFSCommand) a(e, n);
      return !0;
    }
    addModalJavaScript(e) {
      ...
      e.parentNode.addEventListener("click", a);
      ...
      const n = e.querySelector("#mute-checkbox"),
        ...
        i = () => {
          if (this.volumeSettings.isMuted)
            ...
            t.forEach((n, a) => {
              n.style.display = a === e ? "inline" : "none";
            });
          }
        };
    ...
    updateStyles() {
      if (this.dynamicStyles.sheet) {
        ...
        if (null != e) {
          ...
          a && this.dynamicStyles.sheet.insertRule(`:host { ${a} }`);
        }
    ...
    confirmReloadSave(e, n, a) {
      if (gn(n) && localStorage[e]) {
        if (!a) {
          if (!confirm(Ce("save-delete-prompt"))) return;
        }
        const t = this.swfUrl ? this.swfUrl.pathname : "",
    ...
    async backupSaves() {
      ...
      Object.keys(localStorage).forEach((a) => {
        let t = String(a.split("/").pop());
        const r = localStorage.getItem(a);
        if (r && gn(r)) {
          const a = vn(r),
            o = n.filter((e) => e === t).length;
          (n.push(t), o > 0 && (t += ` (${o + 1})`), e.addFile(t + ".sol", a));
        }
      });
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new ln(e.pageX, e.pageY),
          a = this.pointerDownPosition.distanceTo(n);
        a > this.pointerMoveMaxDistance && (this.pointerMoveMaxDistance = a);
      }
    }
    checkLongPress(e) {
      this.longPressTimer
    ...
    showContextMenu(e) {
      ...
      const n = this.element.getBoundingClientRect(),
        a = this.contextMenuElement.getBoundingClientRect(),
        t = document.scrollingElement || document.body,
        r = Math.max(0, e.clientX + a.width - t.clientWidth),
        o = Math.max(0, e.clientY + a.height - t.clientHeight),
        i = e.clientX - n.x - r,
        s = e.clientY - n.y - o,
    ...
    getPanicData() {
      ...
      if (
        ...
        for (const [n, a] of Object.entries(this.metadata)) e += `${n}: ${a}\n`;
      return e;
    }
    panic(e) {
      if (this.panicked) return;
    ...
    displayRootMovieDownloadFailedMessage(e, n) {
      const a = this.loadedConfig?.openInNewTab;
      if (a && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        this.addOpenInNewTabMessage(a, this.swfUrl);
      else {
        const a = n.includes("HTTP Status is not OK:"),
          t = e ? new Le(this.swfUrl) : new We(this.swfUrl, a);
        this.panic(t);
      }
    }
  ...
  function dn(e, n) {
    const a = { url: e },
      t = n("allowNetworking");
    null !== t && (a.allowNetworking = t);
    const r = wn(n("allowScriptAccess"), e);
    null !== r && (a.allowScriptAccess = r);
    const o = n("bgcolor");
    null !== o && (a.backgroundColor = o);
    const i = n("base");
    if (null !== i)
      if ("." === i) {
        const n = new URL(e, document.baseURI);
        a.base = new URL(i, n).href;
      } else a.base = i;
    const s = bn(n("menu"));
    null !== s && (a.menu = s);
    const l = bn(n("allowFullScreen"));
    null !== l && (a.allowFullscreen = l);
    const u = n("flashvars");
    null !== u && (a.parameters = u);
    const c = n("quality");
    null !== c && (a.quality = c);
    const d = n("salign");
    null !== d && (a.salign = d);
    ...
    return (null !== p && (a.fullScreenAspectRatio = p), a);
  }
  function fn(e) {
    if (e) {
      let n = "",
  ...
  function mn(e, n) {
    const a = e.getAttribute(n),
      t = window.RufflePlayer?.config ?? {};
    if (a)
      try {
        const r = new URL(a);
        "http:" !== r.protocol ||
          "https:" !== window.location.protocol ||
          ("upgradeToHttps" in t && !1 === t.upgradeToHttps) ||
  ...
  function hn(e, n) {
    ...
    ((t.href = a), (t.download = n), t.click(), URL.revokeObjectURL(a));
  }
  function vn(e) {
    const n = atob(e);
  ...
  function gn(e) {
    try {
      ...
      return (
        ...
        191 === n.charCodeAt(1) &&
        "TCSO" === n.slice(6, 10) &&
        [0, 4, 0, 0, 0, 0].every((e, a) => n.charCodeAt(10 + a) === e)
      );
    } catch (e) {
      return !1;
    }
  ...
  class An extends HTMLElement {
    ...
    get readyState() {
      return Sn(this, xn, "f")._readyState;
    }
    get metadata() {
      return Sn(this, xn, "f").metadata;
    }
    constructor() {
      (super(),
        xn.set(this, void 0),
    ...
    ruffle(e) {
      if (1 === (e ?? 1)) return new jn(Sn(this, xn, "f"));
      throw new Error(`Version ${e} not supported.`);
    }
    get loadedConfig() {
      return Sn(this, xn, "f").loadedConfig ?? null;
    }
    connectedCallback() {
      Sn(this, xn, "f").updateStyles();
    }
    static get observedAttributes() {
      return ["width", "height", "align"];
    }
    attributeChangedCallback(e, n, a) {
      An.observedAttributes.includes(e) && Sn(this, xn, "f").updateStyles();
    }
    disconnectedCallback() {
      Sn(this, xn, "f").destroy();
    }
    async reload() {
      await Sn(this, xn, "f").reload();
    }
    async load(e, n = !1) {
      await Sn(this, xn, "f").load(e, n);
    }
    play() {
      Sn(this, xn, "f").play();
    }
    get isPlaying() {
      return Sn(this, xn, "f").isPlaying;
    }
    get volume() {
      return Sn(this, xn, "f").volume;
    }
    set volume(e) {
      Sn(this, xn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return Sn(this, xn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return Sn(this, xn, "f").isFullscreen;
    }
    setFullscreen(e) {
      Sn(this, xn, "f").setFullscreen(e);
    }
    enterFullscreen() {
      Sn(this, xn, "f").enterFullscreen();
    }
    exitFullscreen() {
      Sn(this, xn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await Sn(this, xn, "f").downloadSwf();
    }
    pause() {
      Sn(this, xn, "f").pause();
    }
    set traceObserver(e) {
      Sn(this, xn, "f").traceObserver = e;
    }
    debugPlayerInfo() {
      return "";
    }
    PercentLoaded() {
      return Sn(this, xn, "f")._readyState === u.Loaded ? 100 : 0;
    }
    get config() {
      return Sn(this, xn, "f").config;
    }
    set config(e) {
      Sn(this, xn, "f").config = e;
    }
    displayMessage(e) {
      Sn(this, xn, "f").displayMessage(e);
    }
  }
  function En(e, n) {
    if (e) {
      for (const a of e.attributes)
        if (a.specified) {
          if ("title" === a.name && "Adobe Flash Player" === a.value) continue;
          try {
  ...
  class Fn extends An {
    ...
    static isInterdictable(e) {
      ...
      return !!n && !pn(e) && (fn(n) ? (mn(e, "src"), !1) : Oe(n, a));
    }
  ...
  function qn(e) {
    ...
    for (const a of e.children)
      if (a instanceof HTMLParamElement) {
        const e = a.attributes.getNamedItem("name")?.value,
          t = a.attributes.getNamedItem("value")?.value;
        e && t && (n[e] = t);
      }
    return n;
  }
  class Pn extends An {
    ...
    static isInterdictable(e) {
      ...
      if (n) {
        ...
        if (!t || !t.movie) return !1;
        if (fn(t.movie)) {
          const n = e.querySelector("param[name='movie']");
          if (n) {
            mn(n, "value");
            const a = n.getAttribute("value");
            a && e.setAttribute("data", a);
          }
          return !1;
        }
        r = t.movie;
  ...
  class Un {
    ...
    namedItem(e) {
      return _n(this, $n, "f")[e];
    }
    get length() {
      return _n(this, Dn, "f").length;
    }
    [((Dn = new WeakMap()), ($n = new WeakMap()), Symbol.iterator)]() {
  ...
  function na() {
    ((Gn = Gn ?? document.getElementsByTagName("iframe")),
      ...
      [Gn, Xn].forEach((e) => {
        for (const n of e) {
          ...
          const e = n.contentWindow,
            a = `Couldn't load Ruffle into ${n.tagName}[${n.src}]: `;
          try {
            "complete" === e.document.readyState && aa(e, a);
          } catch (e) {
            Ie || console.warn(a + e);
          }
          n.addEventListener(
