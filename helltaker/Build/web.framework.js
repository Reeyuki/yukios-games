var unityFramework = (() => {
  ...
  return function (unityFramework) {
    ...
    var asmLibraryArg = {
      ...
      Zd: _JS_Accelerometer_Stop,
      Sa: _JS_CallAsLongAsNoExceptionsSeen,
      ...
      _a: _JS_GravitySensor_Start,
      Ud: _JS_GravitySensor_Stop,
      Rd: _JS_GuardAgainstJsExceptions,
      Td: _JS_Gyroscope_IsRunning,
      Za: _JS_Gyroscope_Start,
      Sd: _JS_Gyroscope_Stop,
      dc: _JS_Init_ContextMenuHandler,
      Yd: _JS_LinearAccelerationSensor_IsRunning,
      $a: _JS_LinearAccelerationSensor_Start,
      Wd: _JS_LinearAccelerationSensor_Stop,
      nd: _JS_Log_Dump,
      zd: _JS_Log_StackTrace,
      Jd: _JS_MobileKeybard_GetIgnoreBlurEvent,
      ka: _JS_MobileKeyboard_GetKeyboardStatus,
      td: _JS_MobileKeyboard_GetText,
      pd: _JS_MobileKeyboard_GetTextSelection,
      ud: _JS_MobileKeyboard_Hide,
      qd: _JS_MobileKeyboard_SetCharacterLimit,
      rd: _JS_MobileKeyboard_SetText,
      od: _JS_MobileKeyboard_SetTextSelection,
      Ta: _JS_MobileKeyboard_Show,
      ae: _JS_OrientationSensor_IsRunning,
      bb: _JS_OrientationSensor_Start,
      $d: _JS_OrientationSensor_Stop,
      cb: _JS_RequestDeviceSensorPermissionsOnTouch,
      cd: _JS_RunQuitCallbacks,
      Qd: _JS_ScreenOrientation_DeInit,
      ce: _JS_ScreenOrientation_Init,
      S: _JS_ScreenOrientation_Lock,
      jf: _JS_Sound_Create_Channel,
      wa: _JS_Sound_GetLength,
      cf: _JS_Sound_GetLoadState,
      af: _JS_Sound_Init,
      qb: _JS_Sound_Load,
      bf: _JS_Sound_Load_PCM,
      va: _JS_Sound_Play,
      ya: _JS_Sound_ReleaseInstance,
      db: _JS_Sound_ResumeIfNeeded,
      ff: _JS_Sound_Set3D,
      _e: _JS_Sound_SetListenerOrientation,
      $e: _JS_Sound_SetListenerPosition,
      ef: _JS_Sound_SetLoop,
      rb: _JS_Sound_SetLoopPoints,
      ua: _JS_Sound_SetPaused,
      df: _JS_Sound_SetPitch,
      hf: _JS_Sound_SetPosition,
      gf: _JS_Sound_SetVolume,
      xa: _JS_Sound_Stop,
      Me: _JS_SystemInfo_GetBrowserName,
      xd: _JS_SystemInfo_GetBrowserVersionString,
      Pd: _JS_SystemInfo_GetCanvasClientSize,
      Oe: _JS_SystemInfo_GetDocumentURL,
      gd: _JS_SystemInfo_GetGPUInfo,
      wd: _JS_SystemInfo_GetLanguage,
      Xa: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
      _: _JS_SystemInfo_GetMemory,
      yd: _JS_SystemInfo_GetOS,
      Va: _JS_SystemInfo_GetPreferredDevicePixelRatio,
      Cd: _JS_SystemInfo_GetScreenSize,
      ge: _JS_SystemInfo_HasAstcHdr,
      Ua: _JS_SystemInfo_HasCursorLock,
      Nd: _JS_SystemInfo_HasFullscreen,
      da: _JS_SystemInfo_HasWebGL,
      ld: _JS_UnityEngineShouldQuit,
      oe: _JS_Video_CanPlayFormat,
      Le: _JS_Video_Create,
      Ge: _JS_Video_Destroy,
      Ae: _JS_Video_Duration,
      Fe: _JS_Video_EnableAudioTrack,
      we: _JS_Video_GetAudioLanguageCode,
      xe: _JS_Video_GetNumAudioTracks,
      qe: _JS_Video_GetPlaybackRate,
      Be: _JS_Video_Height,
      De: _JS_Video_IsPlaying,
      ze: _JS_Video_IsReady,
      re: _JS_Video_IsSeeking,
      pb: _JS_Video_Pause,
      Ee: _JS_Video_Play,
      ob: _JS_Video_Seek,
      Je: _JS_Video_SetEndedHandler,
      Ke: _JS_Video_SetErrorHandler,
      ye: _JS_Video_SetLoop,
      ue: _JS_Video_SetMute,
      pe: _JS_Video_SetPlaybackRate,
      He: _JS_Video_SetReadyHandler,
      Ie: _JS_Video_SetSeekedHandler,
      ve: _JS_Video_SetVolume,
      se: _JS_Video_Time,
      te: _JS_Video_UpdateToTexture,
      Ce: _JS_Video_Width,
      pf: _JS_WebCamVideo_CanPlay,
      sf: _JS_WebCamVideo_GetDeviceName,
      sb: _JS_WebCamVideo_GetNativeHeight,
      tb: _JS_WebCamVideo_GetNativeWidth,
      tf: _JS_WebCamVideo_GetNumDevices,
      nf: _JS_WebCamVideo_GrabFrame,
      rf: _JS_WebCamVideo_IsFrontFacing,
      qf: _JS_WebCamVideo_Start,
      mf: _JS_WebCamVideo_Stop,
      of: _JS_WebCamVideo_Update,
      ub: _JS_WebCam_IsSupported,
      Xe: _JS_WebRequest_Abort,
      Te: _JS_WebRequest_Create,
      Ue: _JS_WebRequest_GetResponseMetaData,
      Ve: _JS_WebRequest_GetResponseMetaDataLengths,
      We: _JS_WebRequest_Release,
      Pe: _JS_WebRequest_Send,
      Re: _JS_WebRequest_SetRedirectLimit,
      Qe: _JS_WebRequest_SetRequestHeader,
      ...
      vc: ___syscall_chmod,
      Ad: ___syscall_connect,
      xc: ___syscall_faccessat,
      J: ___syscall_fcntl64,
      fe: ___syscall_fstat64,
      rc: ___syscall_getcwd,
      oc: ___syscall_getdents64,
      Na: ___syscall_ioctl,
      Xd: ___syscall_lstat64,
      qc: ___syscall_mkdir,
      be: ___syscall_newfstatat,
      Ra: ___syscall_openat,
      ec: ___syscall_readlinkat,
      id: ___syscall_recvfrom,
      tc: ___syscall_renameat,
      pc: ___syscall_rmdir,
      sd: ___syscall_sendto,
      Qa: ___syscall_socket,
      de: ___syscall_stat64,
      kf: ___syscall_statfs64,
      lf: ___syscall_truncate64,
      ...
      Dd: _emscripten_exit_pointerlock,
      Bd: _emscripten_get_canvas_element_size,
      Kd: _emscripten_get_fullscreen_status,
      na: _emscripten_get_gamepad_status,
      Qg: _emscripten_get_heap_max,
      C: _emscripten_get_now,
      bg: _emscripten_get_now_res,
      oa: _emscripten_get_num_gamepads,
      ed: _emscripten_html5_remove_all_event_listeners,
      je: _emscripten_is_webgl_context_lost,
      z: _emscripten_log,
      yh: _emscripten_memcpy_big,
      Md: _emscripten_request_fullscreen,
      Ed: _emscripten_request_pointerlock,
      zh: _emscripten_resize_heap,
      pa: _emscripten_sample_gamepad_data,
      Wa: _emscripten_set_blur_callback_on_thread,
      ma: _emscripten_set_canvas_element_size,
      Gd: _emscripten_set_focus_callback_on_thread,
      ...
      Fd: _emscripten_set_pointerlockchange_callback_on_thread,
      gb: _emscripten_set_touchcancel_callback_on_thread,
      ...
      le: _emscripten_webgl_create_context,
      ke: _emscripten_webgl_destroy_context,
      ca: _emscripten_webgl_enable_extension,
      ie: _emscripten_webgl_get_current_context,
      me: _emscripten_webgl_init_context_attributes,
      ...
      _b: _glColorMask,
      ch: _glCompileShader,
      ah: _glCompressedTexImage2D,
      Vf: _glCompressedTexImage3D,
      bh: _glCompressedTexSubImage2D,
      ...
      Af: _glDeleteSamplers,
      Sg: _glDeleteShader,
      wb: _glDeleteSync,
      Rg: _glDeleteTextures,
      $f: _glDeleteVertexArrays,
      Yb: _glDepthFunc,
      Xb: _glDepthMask,
      Pg: _glDetachShader,
      Og: _glDisable,
      ...
      yg: _glGetError,
      xg: _glGetFramebufferAttachmentParameteriv,
      rh: _glGetIntegeri_v,
      Ia: _glGetIntegerv,
      ...
      K: _glGetProgramiv,
      Eb: _glGetQueryObjectuiv,
      cg: _glGetQueryiv,
      Ig: _glGetRenderbufferParameteriv,
      vg: _glGetShaderInfoLog,
      Vb: _glGetShaderPrecisionFormat,
      wg: _glGetShaderSource,
      th: _glGetShaderiv,
      ug: _glGetString,
      Sf: _glGetStringi,
      tg: _glGetTexParameteriv,
      ...
      Hf: _glReadBuffer,
      P: _glReadPixels,
      qg: _glRenderbufferStorage,
      Rf: _glRenderbufferStorageMultisample,
      Cf: _glSamplerParameteri,
      Sb: _glScissor,
      og: _glShaderSource,
      pg: _glStencilFuncSeparate,
      mg: _glStencilMask,
      ng: _glStencilOpSeparate,
      jg: _glTexImage2D,
      Wf: _glTexImage3D,
      kg: _glTexParameterf,
      Fa: _glTexParameteri,
      ...
      gc: invoke_iiiiiiiiiiii,
      Qc: invoke_iiiiiiiiiji,
      Vc: invoke_iiiijii,
      _c: invoke_iiijiii,
      $c: invoke_iij,
      zc: invoke_iiji,
